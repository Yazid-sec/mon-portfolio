      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Discutons d'opportunités en pentest, tests d'intrusion ou échangeons
            autour de la sécurité offensive
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="mb-8 p-6 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
              <h4 className="font-semibold text-[var(--primary-color)] dark:text-red-300 mb-3 text-center text-lg">
                Disponibilité
              </h4>
              <p className="text-[var(--primary-color)] dark:text-red-400 text-center">
                Actuellement en Ingénierie informatique en Cybersécurité à
                HESTIM - je suis à la recherche d'un PFA en tant que pentester /
                testeur d'intrusion
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <div className="text-gray-600 dark:text-gray-300 text-center mb-6">
                <p className="text-lg">
                  Je recherche un PFA en tant que{" "}
                  <span className="text-[var(--primary-color)] font-semibold">
                    pentester
                  </span>{" "}
                  pour appliquer mes compétences en tests d'intrusion,
                  exploitation de vulnérabilités et sécurité offensive
                </p>
              </div>
