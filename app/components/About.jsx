          ...
          <div className="lg:w-2/3">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-300">
              <p className="text-lg leading-relaxed">
                ...
                , je me spécialise dans l'exploitation de vulnérabilités et les
                tests d'intrusion.
              </p>

              <p className="text-lg leading-relaxed">
                Mon expérience en développement d'applications web et mobiles me
                donne une compréhension approfondie des architectures
                applicatives, essentielle pour identifier et tester les
                vulnérabilités.
              </p>
              ...
              <p className="text-lg leading-relaxed">
                Mon objectif actuel :{" "}
                <span className="text-[var(--primary-color)] font-semibold">
                  Réaliser un PFA en pentest
                </span>
                , pour appliquer mes connaissances en analyse de vulnérabilités,
                tests d'intrusion et développement d'outils de sécurité
                offensive.
              </p>
            </div>
                ...
                <div className="flex justify-center">
                  {isMounted ? (
                    <div
                      ...
                      data-share-badge-id="041a5de6-2ede-4880-b680-3f346227c58e"
